...
| `packet-tracer/basic-router-switch-network.pkt` | Completed Packet Tracer lab file |
| `configs/R1-config.txt`                 | Final R1 configuration           |
| `configs/S1-config.txt`                 | Final S1 configuration           |
