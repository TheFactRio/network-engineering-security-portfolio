...
![ping from S1 to PC-B](./screenshots/ping-s1-to-pc-b.png)
...
| [basic-router-switch-network.pka](./packet-tracer/basic-router-and-switch-network.pka) | Completed Packet Tracer lab file |
