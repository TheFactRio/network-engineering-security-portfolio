...
![BR1 to BR2 Link Test](./screenshots/br1-to-br2-link-tests.png)
...
![BR2 to BR1 Link Test](./screenshots/br2-to-br1-link-tests.png)

### Expected Failed Ping to Remote LAN Interface

BR2 attempted to ping the BR1 LAN interface:

![BR2 ping the BR1 LAN](./screenshots/br2-pings-br1-lan.png)
...
| [vlsm-design-and-implementation.pka](./packet-tracer/vlsm-design-and-implementation.pka) | Completed Packet Tracer lab file |
